...
ExprType arithmetic_aux_add(ExprContainer *container, ExprData *ari_fake_expr_var, ExprData *right_fake_expr_var, const char *register_name){
    // storing left side of expression in memory, calculating its value if it is necessary
    ExprType left_type = store_stackpop_in_fake_var(container, ari_fake_expr_var, register_name);
...
ExprType arithmetic_aux_sub(ExprContainer *container, ExprData *ari_fake_expr_var, ExprData *right_fake_expr_var, const char *register_name){
...
ExprType arithmetic_aux_mul(ExprContainer *container, ExprData *ari_fake_expr_var, ExprData *right_fake_expr_var, const char *register_name){
    // storing left side of expression in memory, calculating it if it is necessary
    ExprType left_type = store_stackpop_in_fake_var(container, ari_fake_expr_var, register_name);
    // loading left side of expression into the correct register
    load_var_into_register(container, ari_fake_expr_var, "rax");
...
ExprType arithmetic_aux_div(ExprContainer *container, ExprData *ari_fake_expr_var, ExprData *right_fake_expr_var, const char *register_name){
    // storing left side of expression in memory, calculating it if it is necessary
    ExprType left_type = store_stackpop_in_fake_var(container, ari_fake_expr_var, register_name);
    // loading left side of expression into the correct register
    load_var_into_register(container, ari_fake_expr_var, "rax");
...
ExprType arithmetic_aux_mod(ExprContainer *container, ExprData *ari_fake_expr_var, ExprData *right_fake_expr_var, const char *register_name){
    // storing left side of expression in memory, calculating it if it is necessary
    ExprType left_type = store_stackpop_in_fake_var(container, ari_fake_expr_var, register_name);
    // loading left side of expression into the correct register
    load_var_into_register(container, ari_fake_expr_var, "rax");
...
ExprType arithmetic_aux_neg(ExprContainer *container, ExprData *ari_fake_expr_var, ExprData *right_fake_expr_var){
    // loading right side of expression into the correct register
    ExprType type = load_var_into_register(container, right_fake_expr_var, "rax");
    // performing negation
...
TypesEnum store_arithmetic_in_fake_var(ExprContainer *container, const ExprData *arithmetic_expression, const char *register_name){
    ExprType ar_type = arithmetic_expression->type;
