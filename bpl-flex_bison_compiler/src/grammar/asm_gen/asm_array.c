...
void prepare_index_and_check(ExprContainer *container, VarData *array, ExprData *fake_expr){
    ...
    ExprType fake_exprtype = store_stackpop_in_fake_var(container, fake_expr, internal_register);
...
ExprType load_array_into_register(ExprContainer *container, const ExprData *expression, const char *register_name){
...
ExprType load_array_address_into_register(ExprContainer *container, const ExprData *expression, const char *register_name){
